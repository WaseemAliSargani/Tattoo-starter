...
export const testimonialData = [
  {
    quoteImg: QuoteImg,
    message:
      "Ek saamander hai jo mere kabu mai hai aur ek qatra hai jo mugjse sanbhala nhi jata,  ek aumar hai jo bitani hai auske bager aur ek lamha hai jo mugh se guzara nhi jata.",
    name: 'Jackson',
