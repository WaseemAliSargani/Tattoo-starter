...
const Interview = () => {
  ...
  className='bg-dark section bg-no-repeat bg-cover bg-interview bg-center lg:h-[812px] '>
    <div className="container mx-auto h-full">
      <div className='flex flex-col justify-center h-full '>
        <div className='flex flex-col items-start max-w-[880px]'>
          ...
          {/* modal video */}
          <ModelVideo channel="youtube" autoplay isOpen={isOpen} videoId="_l1mqYQuNf8"
