      ...
      <div className='flex flex-col xl:flex-row gap-y-16'>
            ...
            {info.map((item, index) => {
              ...
              return (
                ...
                <div key={index}>
                  ...
                  {/* subtitle */}
                  <div className='mb-6 text-[#333] leading-[187%] tracking-[0.02rem]'> {subtitle} </div>
                  {/* address, phone & email */}
        ...
        viewport={{ once: false, amount: 0.4 }}
         className='flex-1 xl:pl-[40px] flex justify-center items-center'>
          ...
          <input className='border-b border-dark placeholder:text-[#555]n italic tracking-[0.06em] outline-none pb-4' type="text"
